...
На основе списка постов за неделю напиши ТОЛЬКО короткое вступление к дайджесту: 1-2 предложения, живой цепляющий тон, обозначь главную тему/настроение недели.
НЕ перечисляй посты, НЕ нумеруй, НЕ пиши выводы — только вступительный абзац. Пиши на русском."""
